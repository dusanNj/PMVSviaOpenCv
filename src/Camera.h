#pragma once
    ...
    class Camera {
        public:
            ...
            float computeDepth(const Vec4f& point);
            Vec4f getOpticalCenter(void) const;
            void updateProjection(void);
            static void setProjection(const std::vector<float>& intrinsics, const std::vector<float>& extrinsics,
                                      std::vector<Vec4f>& projection, const int txtType);
            ...
            Vec3f project(const Vec4f& coord, const int level) const;
