#pragma once
    ...
    class DetectFeatures {
        public:
            ...
            void run(std::string path, std::string name, const int csize);
            ...
            Vec3f getColor(const Vec4f& coord, const int index, const int level) {
            ...
            Vec3f getColor(const int index, const float fx, const float fy, const int level) const;
